-- Migration: Add parent_id to create_invoice_with_lines RPC
--
-- PURPOSE: The invoice creation RPC needs to write parent_id from the caller-supplied
-- JSONB blob. No signature change — p_invoice already accepts free-form JSONB.
-- Required by issue #5: invoice creation parent-first flow.
--
